function [TorqueGear, TorquePinion, GearMidX, PinionMidX] = torqueDiagram(GshoulderX,PshoulderX,FzGear, FzPinion,GearDiameter,PinionDiameter,GearWidth, PinionWidth)
